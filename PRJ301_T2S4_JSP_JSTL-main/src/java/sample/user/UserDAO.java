...
public class UserDAO {
    ...
    private static final String LOGIN = "SELECT id,fullName, roleID FROM tblUsers WHERE userID=? "
            + "AND password=?";
        ...
        try {
            ...
            if (conn != null) {
                ...
                if (rs.next()) {
                    ...
                    user = new UserDTO(id, userID, fullName, roleID, "");
                }
            }
        } catch (Exception e) {
            e.printStackTrace();
    ...
    public boolean editNameUser(String fullName,int id) throws ClassNotFoundException {
        boolean check = false;
        Connection conn = null;
        PreparedStatement ptm = null;
