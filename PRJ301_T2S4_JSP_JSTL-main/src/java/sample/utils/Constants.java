...
public class Constants {
    public static String GOOGLE_CLIENT_ID = "744369254484-j7pier6bvdc2pqsaoelm03neud2461o6.apps.googleusercontent.com";
    public static String GOOGLE_CLIENT_SECRET = "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";
