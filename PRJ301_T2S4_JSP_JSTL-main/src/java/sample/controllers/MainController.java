...
public class MainController extends HttpServlet {
    ...
    private static final String MENU_CONTROLLER = "ProductsController?cid=0";
    private static final String UPDATE_PRODUCT = "UpdateProduct";
    private static final String UPDATE_PRODUCT_CONTROLLER = "ManagementUpdateProductController";
